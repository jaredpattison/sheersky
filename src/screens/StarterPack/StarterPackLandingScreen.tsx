    ...
    <View style={[a.flex_1]}>
      <Layout.Content ignoreTabletLayoutOffset>
        ...
        <View style={[a.gap_2xl, a.mx_lg, a.my_2xl]}>
          ...
          <View style={[a.gap_sm]}>
            <Button
              label={_(msg`Join SheerSky`)}
              onPress={onJoinPress}
              variant="solid"
              color="primary"
              size="large">
              <ButtonText style={[a.text_lg]}>
                <Trans>Join SheerSky</Trans>
              </ButtonText>
            </Button>
      ...
      <Prompt.Outer control={androidDialogControl}>
        <Prompt.Content>
          <Prompt.TitleText>
            <Trans>Download SheerSky</Trans>
          </Prompt.TitleText>
          <Prompt.DescriptionText>
            <Trans>
              The experience is better in the app. Download SheerSky now and
      ...
      {IS_WEB && (
        <meta
          ...
          content="app-id=6759801426, app-clip-bundle-id=com.sheersky.app.AppClip, app-clip-display=card"
        />
      )}
    </View>
  )
      ...
      <View style={[a.flex_1, a.px_lg, {marginTop: 250}]}>
        ...
        <View style={[a.gap_md, {zIndex: 2}]}>
          <Text
            ...
            Download SheerSky to get started!
          </Text>
