    ...
    <Layout.Screen>
      ...
      <Layout.Content>
        <SettingsList.Container>
          <View style={[a.px_lg, a.pt_md, a.pb_sm]}>
            <Admonition type="info">
              <Trans>
                Push notifications are not yet available in SheerSky. In-app
                notifications work normally — check the Notifications tab to
                stay up to date.
              </Trans>
            </Admonition>
          </View>
