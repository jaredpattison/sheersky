...
export function createStarterPackGooglePlayUri(
  ...
  if (!name || !rkey) return null
  // TODO: Replace with SheerSky app ID when available
  return `https://play.google.com/store/apps/details?id=app.sheersky&referrer=utm_source%3Dsheersky%26utm_medium%3Dstarterpack%26utm_content%3Dstarterpack_${name}_${rkey}`
}
