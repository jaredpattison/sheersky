...
export function useIntentHandler() {
  ...
  React.useEffect(() => {
    const handleIncomingURL = async (url: string) => {
      ...
      // On native, our links look like sheersky://intent/SomeIntent, so we have to check the hostname for the
    ...
    ({
      ...
      const imageUris = imageUrisStr
        ...
        .filter(part => {
          ...
          // be able to provide some link like "sheersky://intent/compose?imageUris=https://IHaveYourIpNow.com/image.jpeg
